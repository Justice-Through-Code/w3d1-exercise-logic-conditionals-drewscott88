...
def snippet_4():
    ...
    # first statement true but second statement is not true and since were using the and not opperator both statements have to be true in order for the print statement to print false
snippet_4()
def snippet_5():
